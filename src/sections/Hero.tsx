...
export default function Hero() {
  return (
    <section
      id="home"
      className="relative overflow-hidden border-b bg-gradient-to-br from-pastel-sky to-pastel-peach"
    >
      <Container className="grid items-center gap-10 py-16 md:grid-cols-2 md:py-24">
        <div>
          <div className="flex flex-wrap items-center gap-2 mb-2">
            <Badge>Family-Owned</Badge>
            <Badge>City-Licensed</Badge>
          </div>

          {/* 👶 New infants & toddlers badge */}
          <Badge className="mb-4 bg-emerald-50 text-emerald-800 border border-emerald-200">
            Now enrolling
          </Badge>
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <a href="#contact">
              <Button className="rounded-2xl" aria-label="Enroll Now">
                Enroll Now
              </Button>
            </a>
            <a href="#programs">
              <Button variant="outline" className="rounded-2xl" aria-label="Explore Programs">
                Explore Programs
              </Button>
            </a>
          </div>
        ...
        <div className="relative">
          ...
          <img
            src="../../public/images/display-image.jpeg"
          ...
          <div className="card absolute -bottom-6 -left-6 w-64">
            <div className="flex items-center gap-3 p-4">
              <div className="rounded-xl bg-pastel-lavender p-2 text-slate-800">
